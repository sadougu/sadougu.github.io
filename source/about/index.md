...
- [常用 AI 平台快捷导航](/2026/06/22/常用-AI-平台与工具快捷导航/)

更多文章见 [归档](/archives/)。

## 关于作者

我是 **sadougu**，在新加坡生活，日常关注本地消费优惠和理财工具。这个站点的文章基于公开信息整理，部分评测含邀请码或推荐链接——如果通过链接开户，你我可能各得迎新奖励，但**不构成财务或投资建议**，开户前请自行核对官方条款。

## 技术说明

本站使用 [Hexo](https://hexo.io/) + [FlatPaper](https://github.com/Homulilly/hexo-theme-flatpaper) 主题搭建，托管在 [GitHub Pages](https://pages.github.com/)，推送代码后由 GitHub Actions 自动构建发布。文章主要在 [Cursor](https://cursor.com/) 中用 [Grok](https://x.ai/) 辅助撰写与推送。

源码开源：[github.com/sadougu/sadougu.github.io](https://github.com/sadougu/sadougu.github.io)
